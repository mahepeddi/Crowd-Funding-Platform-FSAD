...
public class ManagerServiceImpl implements ManagerService
{
	...
	@Override
	public List<Campaign> viewcampaignsbymanager(int mid) 
	{
		Manager manager = managerRepository.findById(mid).orElse(null);
		return campaignRepository.findByManager(manager);
	}

	@Override
	public List<BookCampaign> getbookingsbyManager(int mid) 
	{
		return bookCampaignRepository.getbookingsbyManager(mid);
	}
