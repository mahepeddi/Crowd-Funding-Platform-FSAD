...
export default function AddManager() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${config.url}/admin/addcampaignmanager`, formData);
  ...
  return (
    <div>
      <h3 style={{ textAlign: "center", textDecoration: "underline" }}>Add Campaign Manager</h3>
      {
        message ?
