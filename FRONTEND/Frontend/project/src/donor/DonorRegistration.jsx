...
export default function DonoerRegistration() 
{
  ...
  const handleSubmit = async (e) => 
  {
    ...
    try
    {
        const response = await axios.post(`${config.url}/donor/registration`, formData);
  ...
  return (
    <div>
      <h3 style={{ textAlign: "center",textDecoration: "underline"}}>Donor Registration</h3>
      {
            message?
